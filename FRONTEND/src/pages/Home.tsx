...
import { Flame, TrendingUp, Clock, Search, Filter, X } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-white animate-fade-in">
              <span className="text-primary-500">Adult</span> Models
            </h1>
            ...
            <div className="flex items-center justify-center mb-8 text-gray-400 animate-fade-in-up delay-200">
              ...
              <p>Discover {totalItems} models from around the world</p>
            </div>
          </div>
        </div>
      </section>
