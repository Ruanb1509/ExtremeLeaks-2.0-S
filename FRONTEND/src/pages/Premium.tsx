          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 text-center">
              <p className="text-gray-400 mb-4">
                Want to be notified when premium membership becomes available?
              </p>
              <div className="flex flex-col sm:flex-row max-w-md mx-auto">
                <input 
                  type="email" 
                  placeholder="Enter your email" 
                  className="px-4 py-2 bg-dark-200 border border-dark-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 mb-3 sm:mb-0 sm:mr-3 sm:flex-1 text-white" 
                />
